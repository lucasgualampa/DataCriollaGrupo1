...
#print(df_final_clean["order_status"].value_counts())
...
df_d = df_ts2.resample('D').sum()
df_d['y_mean'] = df_ts2.resample('D').mean()
df_d['y_operations'] = df_ts2.resample('D').count()
df_d.isna().sum()
...
fig.update_layout( 
                  ...
                  yaxis_title='Ventas')
# Show the figure
#fig.show() descomentar para grafico
